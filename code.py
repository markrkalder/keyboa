...
keyboard.keymap = [
    ...
    [
       KC.TILD,        KC.F1,         KC.F2,         KC.F3,         KC.F4,         KC.F5,                                                                    KC.F6,         KC.F7,         KC.F8,          KC.F9,         KC.F10,        KC.MINUS,
       ...
       KC.LCTL,       KC.Z,          KC.X,          KC.MUTE,          KC.VOLD,          KC.VOLU,                                                                     KC.MRWD,          KC.MPLY,          KC.MFFD,        KC.DOT,        KC.SLSH,       KC.RSFT,
                      KC.LGUI,       KC1.LALT,       KC.BSPC,       KC.CAPS,        KC.E,      KC.LBRC,        KC.EQL,                            KC.EQL,      KC.RBRC,     KC.RALT,       KC.ENT,        KC.SPC,         KC.E,          KC.RBRC,
   ]
]
# fmt:on
